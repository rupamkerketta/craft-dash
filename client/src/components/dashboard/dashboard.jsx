...
function Dashboard({ user, idea_boards, loadIBS, createIBS, deleteIBS }) {
  ...
  return (
    <div className={` dashboard ${dark ? "" : "dashboard-light"}`}>
      <div className={` top-nav ${dark ? "" : "top-nav-light"}`}>
        ...
        <div className={` add-btn ${dark ? "" : "add-btn-light"}`}>
          <img
            src={AddBtn}
      ...
      <div
        className={` dashboard-title ${dark ? "" : "dashboard-title-light"}`}
      >
        <h1>Dashboard</h1>
      </div>
      ...
      <div
        className={` dashboard-cards-wrapper ${
          dark ? "" : "dashboard-cards-wrapper-light"
        }`}
      >
      ...
      <Rodal
        className={` rodal-bg-blur ${dark ? "" : "rodal-bg-blur-light"}`}
      ...
      >
        <div
          className={` ideaboard-modal ${dark ? "" : "ideaboard-modal-light"}`}
        >
          <div
            className={` ideaboard-header ${
          ...
          >
            ...
            >
              Create New IdeaBoard
            </h1>
          </div>
          <div
            className={` idea-board-form ${
              dark ? "" : "idea-board-form-light"
            }`}
          >
            <Formik
