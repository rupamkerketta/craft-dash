...
import StartRecordingIcon from "../../../img/start-recording-icon.png";
import StopRecordingIcon from "../../../img/stop-recording-icon.png";
  ...
  useEffect(() => {
    ...
    socket.on("user-pointer-updates", (data) => {
      ...
      setPosUpdates((preVal) => {
        const list = [
          ...preVal.filter((preVal) => preVal.email !== data.email),
        ];
            ...
            <ReactMediaRecorder
              ...
              render={({
                ...
                <div className="react-media-recorder-wrapper">
                  ...
                  <audio
                    className="react-media-recorder"
                    src={mediaBlobUrl}
                    controls
                    autoplay
                  />
                  <div className="recorder-button-wrapper">
                    <button id="recording-start" onClick={startRecording}><img src={StartRecordingIcon}/>Start Recording</button>
                    <button id="recording-stop" onClick={stopRecording}><img  src={StopRecordingIcon}/>Stop Recording</button>
                  </div>
                </div>
              )}
            />
