							...
							<Form>
								<div
									className={`emoji-picker-messaging ${
										dark ? '' : 'emoji-picker-messaging-light'
									}`}
									style={{
	...
	return (
		<div className={`message ${dark ? '' : 'message-light'}`}>
			<p className={`chat-meta ${dark ? '' : 'chat-meta-light'}`}>
				{props.data.username}{' '}
				<span className={`time ${dark ? '' : 'time-light'}`}>
					{props.data.time}
				</span>
			</p>
			<div
				className={`chat-content-wrapper ${
					dark ? '' : 'chat-content-wrapper-light'
				}`}>
				<p className={`chat-content ${dark ? '' : 'chat-content-light'}`}>
					{ReactEmoji.emojify(props.data.message)}
				</p>
			</div>
		</div>
	)
